...
function Story() {
    return (
        ...
        <div className ="columns">
            ...
            <ion-icon name="leaf-outline" style= {{fontSize: "60px", color:"#253529",lineHeight: "2.0"}}></ion-icon>
            ...
            <div className = "column">  
            <ion-icon name="walk-outline" style= {{fontSize: "60px",color:"#253529",lineHeight: "2.0" }}></ion-icon>
            ...
            <div className = "column">  
            <ion-icon name="compass-outline" style= {{fontSize: "60px", color:"#253529",lineHeight: "2.0"}}></ion-icon>
